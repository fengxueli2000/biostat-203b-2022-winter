...
summary(model1)
# predict 
prob<-predict(object = model1, newdata=testing, type = "response")
pred<-ifelse(prob >= 0.5, "yes", "no")
pred<-factor(pred, levels = c("no", "yes"), order = TRUE)
table(testing$Dataset_2.thirty_day_mort, pred)
roc_curve <- roc(testing$Dataset_2.thirty_day_mort,prob)
...
prob <- predict(object = model2, newdata = testing, type = "response")
