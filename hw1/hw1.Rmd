...
```
CSV.GZ is a CSV file compressed. CSV file is very big, so it be compressed to be easier to store and send. Core file include patient stay information. ICU file include data collected from cilnical information system used within ICU. HOSP file include hospital level data form patients, like labs and micro information.
